...
function applyLineProps(instance, props) {
  var prevProps = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
...
function applyArcProps(instance, props) {
  var prevProps = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

  applyPathProps(instance, props, prevProps);
  if (props.from !== prevProps.from || props.through !== prevProps.through || props.to !== prevProps.to) {
    var newArc = new _paperCore.Path.Arc(props);
